...
import com.chinuthon.project.uber.uber.ai.service.RiderAiChatService;
...
@RestController
@RequestMapping("/riders/ai")
@RequiredArgsConstructor
@Secured("ROLE_RIDER")
public class RiderAiController {

    private final RiderAiChatService riderAiChatService;
    ...
    public ResponseEntity<AiChatResponseDto> chat(@RequestBody AiChatRequestDto request) {
        ...
        String response = riderAiChatService.chat(request.getMessage(), conversationId);
